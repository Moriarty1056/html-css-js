const st=
 [
    ...
    for (let i = 0; i < st.length; i++) 
    {
        ...
        div.classList = ['container' + (i+1)];
        h2.innerHTML = st[i].title;
        h3.innerHTML = st[i].description;
        img.src = st[i].thumbnail;
    ...
    function getdiv(value) {
        ...
        for (let i = 0; i < value.length; i++) {
            ...
            div.classList = ['container' + (i + 1)];
            h2.innerHTML = value[i].title;
            h3.innerHTML = value[i].description;
            img.src = value[i].thumbnail;
    ...
    function relevance(value,searchterm)
    {
        if(value === searchterm)
            return 2;
    ...
    searchinput.addEventListener('input', (event) => 
    {
        ...
        if( value.trim().length>=0)
        {
            ...
            getdiv(st.filter(p =>
                ...
                {
                    return relevance(pb.title,value)- relevance(pa.title,value);
